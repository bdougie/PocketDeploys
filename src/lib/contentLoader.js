// clone of https://github.com/aschenkel/react-native-content-loader
// TODO: Clean up this file and make relevant to this project
...
export default class ContentLoader extends Component {
    ...
    loopAnimation(count = 0) {
        ...
        Animated.sequence([
          ...
          // Adds a count to prevent the inifinite loop problem
          if (event.finished && count <= 5) {
                this.loopAnimation(count += 1)
            }
        })
    }
    render() {
